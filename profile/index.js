      ...
      <Modal visible={showModal}>
        <ScrollView>
          <View>
            ...
            <Text>Identity</Text>
            <TextInput onChangeText={(valueIde) => setIdentity(valueIde)} />

            <Text>Select Class Name</Text>
            <Picker  onValueChange={(valueNamClass) => setNameClass(valueNamClass)} >
            ...
            <Button
              title="Submit"
              onPress={() => { addSubject(), setShowModal(false) }}
